...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo base_url('UsulanA') ?>">Pengguna</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php echo form_open("UsulanA/ubah/".$UsulanA->id); ?>
      <table cellpadding="8">
        <tr>
          <td>id</td>
          <td><input type="text" name="input_id" value="<?php echo set_value('input_id', $UsulanA->id); ?>" readonly></td>
        </tr>
        <tr>
          <td>Text</td>
          <td><input type="text" name="input_text" value="<?php echo set_value('input_textt', $UsulanA->textt); ?>"></td>
        </tr>
      ...
      <a href="<?php echo base_url('UsulanA'); ?>"><input type="button" value="Batal"></a>
    <?php echo form_close(); ?>
