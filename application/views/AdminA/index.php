...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <?php echo form_open('AdminA/search')?>
                        <input type="search" name="keyword" id="form1" class="form-control" placeholder="Cari data admin..."/>
                    </div>
    ...
    <hr>
    <a href='<?php echo base_url("adminA/tambah"); ?>'>Tambah Data</a><br><br>
    ...
    <thead bgcolor='red'>
      ...
      if( ! empty($adminn)){ // Jika data adminA tidak sama dengan kosong, artinya jika data adminA ada
        foreach($adminn as $data){
          ...
          <td><a href='".base_url("adminA/hapus/".$data->id)."'>Hapus</a></td>
          </tr>";
        }
